...
const connectDb = async () => {
  ...
  const db = await mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.connect("mongodb+srv://Paul:Mau5trap@cluster0-selxu.mongodb.net/test?retryWrites=true&w=majority", {
    useCreateIndex: true,
